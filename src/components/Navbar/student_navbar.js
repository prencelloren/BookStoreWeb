            ...
            <nav className="navbar navbar-inverse">
                <div className="container-fluid">
                    <div className="navbar-header">
                        ...
                        <a className="navbar-brand" >Book Store Website</a>
                    </div>
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            <li> 
                                ...
                                <datalist id="category">
                                    <option value="EDUCATION"><option value="COMICS"></option></option>
                                    </datalist>
                                    </li>

                            <li>
                                <i className="fa fa-search" style={{ color: "white", marginTop: "17px", fontSize: "17px", paddingLeft: "10px" }} onClick={categoryFunction}></i>
                                </li>

                            <li className="active"><Link to="/studentpage">HOME</Link></li>

                            <li><Link to="/yourbooks">BOOKS</Link></li>
